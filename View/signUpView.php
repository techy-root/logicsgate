		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					...
					<div style="color:red; height: 50;"><?php if(isset($userAuth['error']) && !empty($userAuth['error'])) { echo $userAuth['error']; }; ?></div>
						...
						<div class="input-group mb-2">
							...
							value="<?php if(isset($password)){ echo $password;} ?>" placeholder="password*"  pattern="[A-Z][0-9]{8}[!]">
						</div>
                        <div class="input-group mb-3">
							<div class="input-group-append">
							...
							value="<?php if(isset($contact)){ echo $contact;} ?>" placeholder="mobile*" pattern="[1-9][0-9]{9}">
						</div>
                        <div class="input-group mb-3">
							<div class="input-group-append">
							...
							value="<?php if(isset($email)){ echo $email;} ?>" placeholder="email*" required >
						</div>
                        <div class="input-group mb-3">
							<div class="input-group-append">
                            ...
                            <div class="mt-4">
                                <div class="d-flex justify-content-center links">
                                    Have an account? <a href="../index.php" class="ml-2">Sign In</a>
                                </div>
                                <div class="d-flex justify-content-center links">
                                    <a href="../Controller/forgotPasswordController.php">Forgot your password?</a>
                                </div>
                            </div>
					</form>
				</div>
